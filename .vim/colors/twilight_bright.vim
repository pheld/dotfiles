" Vim color file
" Converted from Textmate theme Twilight Bright using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
hi MatchParen ctermfg=172 ctermbg=231 cterm=NONE guifg=#cf7900 guibg=#fdf8f2 gui=NONE
hi StatusLine ctermfg=238 ctermbg=251 cterm=bold guifg=#417598 guibg=#e3f4ff gui=bold
hi StatusLineNC ctermfg=238 ctermbg=251 cterm=NONE guifg=#b3adb4 guibg=#f7f7f7 gui=NONE
...
hi IncSearch ctermfg=NONE ctermbg=188 cterm=NONE guifg=NONE guibg=#ced6e2 gui=NONE
hi Search ctermfg=NONE ctermbg=188 cterm=NONE guifg=NONE guibg=#ced6e2 gui=NONE
